...
public class ImmutableClass {
	...
	// fields of the ImmutableClass class defined final. can be assigned value only once.
		...
		// Getter function for mutable objects: don't send the original copy. Send clone.
